...
<!-- Mirrored from swlabs.co/edugate/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Jul 2019 09:21:07 GMT -->
<head><title>Dimension | About Us</title>
    <meta charset="utf-8">
            ...
            <div class="header-main-wrapper">
                ...
                <nav class="navigation collapse navbar-collapse pull-right">
                    <ul class="nav-links nav navbar-nav">
                        ...
                        <li class="dropdown active"><a href="#" class="main-menu">About Us<span class="fa fa-angle-down icons-dropdown"></span></a>
                            <ul class="dropdown-menu edugate-dropdown-menu-1">
                                <li><a href="about-us.php" class="link-page">About Us</a></li>
                                <li><a href="profile-teacher.php" class="link-page">Profile Teacher</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="courses.php" class="main-menu">Courses</a>
                        </li>
                        <li class="dropdown"><a href="login.php" class="main-menu">Login</a>
                        </li>
        ...
        <div class="main-content"><!-- CONTENT-->
            <div class="content">
                    ...
                    <div class="container">
                        <div class="intro-edu-wrapper">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="intro-title">WHAT IS <b>DIMENSION</b> ?</div>
                ...
                <div class="section section-padding edu-ab">
                    <div class="container">
                        <div class="edu-ab">
                            <div class="group-title-index edu-ab-title"><h2 class="center-title">WITH <b>DIMENSION</b> YOU CAN</h2><h4 class="top-title">Lorem Ipsum is simply dummy text of te printing industry</h4></div>
                        ...
                        <div class="edu-feature-wrapper">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="group-title-index edu-feature-text"><h2 class="center-title">interface friendly learning at dimension</h2>
                    ...
                    <div class="col-2">
                        <div class="col-md-4 col-sm-6 col-xs-6 sd380">
                            <div class="edugate-widget widget">
                                <div class="title-widget">DIMENSION</div>
                                <div class="content-widget"><p>Dimension is a great start for an education personnel or organization to start the online business with 1 Click.</p>
...
<!-- Mirrored from swlabs.co/edugate/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Jul 2019 09:21:08 GMT -->
</html>