<!DOCTYPE html>
<html lang="en">
<head><title>Dimension | Home</title>
    <meta charset="utf-8">
    ...
    <div class="header-topbar">
        <div class="container">
            ...
            <div class="topbar-right pull-right">
                ...
                <!-- <div class="group-sign-in"><a href="login.php" class="login">login</a> --><!-- <a href="register.html" class="register">register</a> --></div>
            </div>
        </div>
    </div>
            ...
            <div class="header-main-wrapper">
                ...
                <nav class="navigation collapse navbar-collapse pull-right">
                    <ul class="nav-links nav navbar-nav">
                        <li class="dropdown active"><a href="index.php" class="main-menu">Home<!-- <span class="fa fa-angle-down icons-dropdown"></span> --></a>
                        ...
                        <li class="dropdown"><a href="courses.php" class="main-menu">Courses<!-- <span class="fa fa-angle-down icons-dropdown"></span> --></a>
                            <!-- <ul class="dropdown-menu edugate-dropdown-menu-1">
                        ...
                        <li class="dropdown"><a href="login.php" class="main-menu">Login<!-- <span class="fa fa-angle-down icons-dropdown"></span> --></a>
                            <!-- <ul class="dropdown-menu edugate-dropdown-menu-1">
    ...
    <div id="page-wrapper"><!-- MAIN CONTENT-->
        <div class="main-content"><!-- CONTENT-->
            <div class="content"><!-- SLIDER BANNER-->
                ...
                <!-- CHOOSE COURSES-->
                <div class="section section-padding choose-course" id="choose-course-section">
                    <div class="container">
        ...
        <div class="container">
            <div class="footer-top-wrapper">
                ...
                <div class="footer-top-right">
                    <button onclick="window.location.href='contact.php'" class="btn btn-blue btn-bold"><span>GET STARTED NOW</span></button>
                </div>
            </div>
        </div>
    </div>
